...
import '../../../video_chat/data/others/asl_detector.dart';
class LearningHandTrackingManager {
  static LearningHandTrackingManager? _instance;
  static LearningHandTrackingManager get instance => _instance ??= LearningHandTrackingManager._();

  LearningHandTrackingManager._();
...
class LearningHandTrackingWidget extends StatefulWidget {
  @override
  _HandTrackingWidgetState createState() => _HandTrackingWidgetState();
}

class _HandTrackingWidgetState extends State<LearningHandTrackingWidget>
    with AutomaticKeepAliveClientMixin {

  final LearningHandTrackingManager _manager = LearningHandTrackingManager.instance;
      ...
      onCreatePlatformView: (params) {
        ...
        view.addOnPlatformViewCreatedListener((id) {
          ...
          EventChannel(
            ...
            try {
              final list = NormalizedLandmarkList.fromBuffer(rawBytes);
              GetIt.instance<ASLDetector>().predictFromLandmarksLearning(list.landmark);
            } catch (e) {
              print("FAILED TO PARSE: $e");
            }
          }, onError: (e) {
