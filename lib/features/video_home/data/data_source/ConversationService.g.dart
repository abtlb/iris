...
class _ConversationService implements ConversationService {
  _ConversationService(this._dio, {this.baseUrl, this.errorLogger}) {
    baseUrl ??= 'http://irisapi.somee.com/api';
  }
  ...
  Future<HttpResponse<List<ConversationModel>>> getConversations() async {
    ...
    final _options = _setStreamType<HttpResponse<List<ConversationModel>>>(
